...
// A command need at least a name and a description module.exports allows this class to be found by
// other files
module.exports =  {
    ...
    async execute(interaction) {
        // Interaction method confirms to Discord that the bot successfully received an interaction
